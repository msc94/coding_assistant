...
class FinishTaskSchema(BaseModel):
    ...
    summary: str = Field(
        description="A concise summary of the work the agent has done on the task. The summary must be a single paragraph, without line breaks. There must be enough context such that the work could be continued based on this summary. It must be possible to evaluate your result using only your input parameters and this summary.",
    )
